...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.content_frame, new ModesFragment()).commit();
    }

    private void setUpTest() {
        TempInfoHolder.getModes().add(new Mode("forward", null, null));
        TempInfoHolder.getModes().add(new Mode("back", null, null));
        TempInfoHolder.getModes().add(new Mode("stop", null, null));
        TempInfoHolder.getTables().add(new TransitionTable("test"));
        TempInfoHolder.getFlags().add(new Flag("left bumper"));
        TempInfoHolder.getFlags().add(new Flag("right bumper"));
    }
